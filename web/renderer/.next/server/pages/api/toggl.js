...
module.exports = __webpack_require__("bHuj");
...
/* harmony import */ var base_64__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("5hJF");
...
async function handler(req, res) {
  ...
  const response = await node_fetch__WEBPACK_IMPORTED_MODULE_0___default()(API_URL + querystring__WEBPACK_IMPORTED_MODULE_1___default.a.stringify({
    startDate,
    endDate
  }), {
    headers: {
      Authorization: `Basic ${Object(base_64__WEBPACK_IMPORTED_MODULE_2__["encode"])(`${process.env.TOGGL_TOKEN}:api_token`)}`
    }
  });
  const json = await response.json();
  res.statusCode = 200;
  res.setHeader('Content-Type', 'application/json');
  res.end(JSON.stringify(json.map(item => {
    const {
      description,
      duration,
      start,
